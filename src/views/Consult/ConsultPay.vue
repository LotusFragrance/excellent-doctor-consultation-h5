...
const agree = ref(false) // 同意支付协议
const loading = ref(false)
const show = ref(false) // 显示抽屉
const orderId = ref('') // 生成订单id
const paymentMethod = ref<0 | 1>() // 选择支付方式
// 生成订单
const submit = async () => {
  ...
  <div class="consult-pay-page" v-if="payInfo">
    ...
    <div class="pay-schema">
      <van-checkbox v-model="agree">
        <span style="margin-right: 3px; font-size: 13px">我已同意</span>
        <span class="text" style="font-size: 13px">支付协议</span>
      </van-checkbox>
    </div>
    <van-submit-bar
      button-type="primary"
